export default () => {
	const structure = '<div class="wrapper">\
					<div class="monitor">\
	...
	document.body.insertAdjacentHTML('afterbegin', structure);


	let out = '';
	for (let i = 0; i < 14; i += 1) {
		if (i === 0) {
			out += `<div class="audio left"></div><div class = "key-area"><div class = "func-keys">\
				<div class = "key func-key esc" id = "f-${i}">esc</div>`;
		} else if (i === 13) {
	...
	for (let i = 0; i < 65; i += 1) {
		switch (i) {
			...
			case 27: {
				out += '</div><div class = "row3"><div class = "key caps sistem" data = "CapsLock" id = "CapsLock">\
